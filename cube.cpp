...
CubeVertexModel::CubeVertexModel() {
    initVertices();
    initIndices();
    initGlObjects();
}

void CubeVertexModel::initVertices() {
    vertices = {
...
void CubeVertexModel::initIndices() {

}

void CubeVertexModel::initGlObjects() {
...
Cube::Cube(glm::vec3 pos, glm::vec3 initialVelocity, float SIZE, float mass, TEXTURES t) {
    worldCoord = pos;
