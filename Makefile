objects = main.o game.o sphere.o shader.o fileManager.o camera.o shape.o textures.o cube.o
...
game.o: game.cpp game.hpp sphere.hpp shader.hpp camera.hpp textures.hpp cube.hpp
